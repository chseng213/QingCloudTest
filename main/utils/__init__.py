...
# help string
config_help_str = """
When you have not edited the configuration file `config.py`,
you need to specify the configuration file,like `/etc/qingcloud/config.py`
and file  content should configure your own qy_access_key_id , qy_secret_access_key and zone
such as:
...
Use string  in  json format to send some not required Parameters,
Parameters that do not exist in the document will be filtered
such as :
'{
"vxnets.1": "vxnet-0",
...
Whether to destroy the host directly, 
if you specify "1", it will not enter the recycle bin and destroy it 
directly, the default is "0"
"""
